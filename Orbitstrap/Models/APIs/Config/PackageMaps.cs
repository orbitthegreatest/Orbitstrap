...
public class PackageMaps
{
	...
	public Dictionary<string, string> PlayerPackageMap { get; set; } = new Dictionary<string, string> { { "RobloxApp.zip", "" } };
	...
	public Dictionary<string, string> this[string key] => key switch
	{
