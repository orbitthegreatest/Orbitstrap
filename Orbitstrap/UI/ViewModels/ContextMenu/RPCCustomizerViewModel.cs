...
namespace Orbitstrap.UI.ViewModels.ContextMenu
{
    public class RPCCustomizerViewModel : INotifyPropertyChanged
    {
        ...
        private string _appName = "Orbitstrap";
        ...
        private void UpdatePresence()
        {
            ...
            try
            {
                ...
                {
                    Details = string.IsNullOrWhiteSpace(Details) ? "Using Orbitstrap" : Details,
                    State = State,
                    Assets = new Assets
                    {
