...
namespace Orbitstrap.UI.ViewModels.Settings
{
    ...
    public sealed partial class NewsViewModel : ObservableObject, IDisposable
    {
        ...
        private const string FeedUrl =
            "https://raw.githubusercontent.com/KloBraticc/OrbitstrapNews-/main/news.json";
        ...
        public NewsViewModel()
        {
            ...
            _http.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("Orbitstrap", "1.0"));
