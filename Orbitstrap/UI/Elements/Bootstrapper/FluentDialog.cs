...
public partial class FluentDialog : WpfUiWindow, IBootstrapperDialog, IComponentConnector
{
	...
	{
		InitializeComponent();
		string robloxVersionStr = Utilities.GetRobloxVersionStr(Bootstrapper?.IsStudioLaunch ?? false);
		string channel = Deployment.Channel;
		_viewModel = new FluentDialogViewModel(this, aero, robloxVersionStr, channel);
		...
		VersionText = Strings.Common_Version + ": " + robloxVersionStr;
