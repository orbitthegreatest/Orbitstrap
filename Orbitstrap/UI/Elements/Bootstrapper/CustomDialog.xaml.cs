...
namespace Orbitstrap.UI.Elements.Bootstrapper
{
    ...
    public partial class CustomDialog : IBootstrapperDialog
    {
        ...
        public CustomDialog()
        {
            ...
            .OfType<Orbitstrap.UI.Elements.Settings.MainWindow>()
            .FirstOrDefault();
            if (App.Settings.Prop.BackgroundWindow)
            {
                _mainWindow?.Hide();
            }
            Orbitstrap.UI.Elements.Bootstrapper.AudioPlayerHelper.PlayStartupAudio();
            this.Closed += (s, e) =>
            {
                _mainWindow = System.Windows.Application.Current.Windows
                .OfType<Orbitstrap.UI.Elements.Settings.MainWindow>()
                ...
                Orbitstrap.UI.Elements.Bootstrapper.AudioPlayerHelper.StopAudio();
            };
            _viewModel = new BootstrapperDialogViewModel(this);
            DataContext = _viewModel;
            Title = App.Settings.Prop.BootstrapperTitle;
            Icon = App.Settings.Prop.BootstrapperIcon.GetIcon().GetSized(256, 256).GetImageSource();
        }
