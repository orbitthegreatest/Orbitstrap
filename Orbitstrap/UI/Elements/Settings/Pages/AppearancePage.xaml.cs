    ...
    public partial class AppearancePage
    {
        ...
        private async void ThemeComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            Frontend.ShowMessageBox(
                "Theme applied!\nIf the theme didn't apply, please restart Orbitstrap.",
        ...
        {
            var url = "https://raw.githubusercontent.com/KloBraticc/OrbitstrapCustomThemes/main/Custom.xaml";
            ...
            {
                // Silently log — the URL may 404 on first run
                App.Logger.WriteException("AppearancePage::DownloadCustomThemeAsync", ex);
            }
        }
