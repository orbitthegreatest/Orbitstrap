...
namespace Orbitstrap.UI.Elements.Installer.Pages
{
    ...
    public partial class WelcomePage
    {
        ...
        {
            Process.Start(new ProcessStartInfo("https://orbitstrapp.netlify.app/donate/donate") { UseShellExecute = true });
        }
        private void ContributorsButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            Process.Start(new ProcessStartInfo("https://orbitstrapp.netlify.app/contributors/contributors") { UseShellExecute = true });
        }
    }
}
