...
{
	public static double ScaleFactor => (double)Screen.PrimaryScreen.Bounds.Width / SystemParameters.PrimaryScreenWidth;

	public static int GetScaledNumber(int number)
	{
		return (int)Math.Ceiling((double)number * ScaleFactor);
	}
