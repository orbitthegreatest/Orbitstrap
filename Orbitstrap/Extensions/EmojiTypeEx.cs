...
internal static class EmojiTypeEx
{
	...
	public static IReadOnlyDictionary<EmojiType, string> Hashes => new Dictionary<EmojiType, string>
	{
		{
			EmojiType.Catmoji,
			"98138f398a8cde897074dd2b8d53eca0"
		},
		{
			EmojiType.Windows11,
			"d50758427673578ddf6c9edcdbf367f5"
		},
		{
			EmojiType.Windows10,
	...
	public static string GetUrl(this EmojiType emojiType)
	{
		...
		return "https://github.com/Orbitstraplabs/rbxcustom-fontemojis/releases/download/my-phone-is-78-percent/" + Filenames[emojiType];
	}
}
