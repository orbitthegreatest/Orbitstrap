    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconOrbitstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconOrbitstrap => Properties.Resources.IconOrbitstrap,
                ...
                _ => Properties.Resources.IconOrbitstrap
            };
        }
    }
}
