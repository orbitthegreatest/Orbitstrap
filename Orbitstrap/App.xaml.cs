...
namespace Orbitstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Orbitstrap-QA";
#else
        public const string ProjectName = "Orbitstrap";
#endif
        public const string ProjectOwner = "Orbitstrap";
        public const string ProjectRepository = "/orbitstrap/Orbitstrap/";
        public const string ProjectDownloadLink = "https://github.com/orbitstrap/Orbitstrap/releases";
        public const string ProjectHelpLink = "https://github.com/BloxstrapLabs/Bloxstrap/wiki";
        public const string ProjectSupportLink = "https://github.com/orbitstrap/Orbitstrap/issues/new";
        ...
        public static void AssertWindowsOSVersion()
        {
            ...
            if (major < 7)
            {
                ...
                if (!LaunchSettings.QuietFlag.Active)
                    Frontend.ShowMessageBox("Your Windows Version is not supported with Orbitstrap!", MessageBoxImage.Error);
        ...
        protected override async void OnStartup(StartupEventArgs e)
        {
            ...
            else
            {
                ...
                // Always flush the shell icon cache on startup so the desktop shortcut
                // and Explorer always display the current logo, even if no upgrade ran.
                Installer.RefreshShellIcons();
